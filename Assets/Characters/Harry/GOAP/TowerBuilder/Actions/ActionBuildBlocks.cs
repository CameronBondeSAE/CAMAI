...
namespace Harry
{
    ...
    public class ActionBuildBlocks : ReGoapAction<string, object>
    {
        protected override void Awake()
        {
            base.Awake();
            preconditions.Set("HaveWood", true);
            preconditions.Set("HaveNails", true);
            effects.Set("BlockAvailable", true);
            effects.Set("HaveWood", false);
            effects.Set("HaveNails", false);
        }
        ...
        public override void Run(IReGoapAction<string, object> previous, IReGoapAction<string, object> next, ReGoapState<string, object> settings, ReGoapState<string, object> goalState, Action<IReGoapAction<string, object>> done, Action<IReGoapAction<string, object>> fail)
        {
            ...
            GetComponent<BuilderMemory>().remainingBlocks = 4;
